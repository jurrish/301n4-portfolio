...
articleView.handleAuthorFilter = function() {
  $('#author-filter').on('change', function() {
    ...
    if ($(this).val()) {
      ...
      $articles.hide();
      $('article[data-attribute="' + $authorOption + '"]').fadeIn();
...
//   var $selection = $(this).val();//this will be a string that will be null, vanilla, chocolate, strawberry
//   //hide all selections
//   $('img').hide();
//   //concatenate a selector again
